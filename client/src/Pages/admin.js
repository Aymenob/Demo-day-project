...
import { cleanLogin, logOUT, DeleteUser, cleanImage, ModifyUser } from "../Redux/usersSlice";
                    ...
                    <div class="col-lg-12 col-md-12 mt-4">
                        ...
                        <div class="shadow-lg p-3 mb-5 bg-body rounded" style={{ backgroundColor: "white" }}>
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        {modify && <td><img  alt='' width="120" height="150" src={user.Image.path} /></td>}{!modify && <th> <input style={{ width: "8cm" }} name="Image" onChange={(e) => { setSelectedFile(e.target.files[0]); dispatch(cleanImage()) }} type="file" /></th>}
