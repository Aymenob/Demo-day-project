                ...
                <div class="col-md-11">
                    <div class="d-flex flex-column comment-section">
                        <div class="bg-white p-2">
                            ...
                            <div class="mt-1">
                            <p  type="input" >{!show&&text}{show&&<input onChange={handleNewTyped} defaultValue={text} class="form-control ml-1 shadow-none textarea" autoFocus style={{marginBottom:"0.55cm",border:"1px solid green",height:"1.3cm",width:"90%",marginLeft:'0.2cm',borderRadius:"4px"}} ></input>}</p>
                            </div>
                        </div>
                        <div style={{marginLeft:"0.4cm",marginTop:"-0.75cm",color:"grey"}} class="">
                            <div class="d-flex flex-row fs-12">
                                ...
                                {show&&<div class="like p-1 cursor"><i class="fa fa-commenting-o"></i><span style={{backgroundColor:"green",color:"white",border:"black solid 2px",borderRadius:"8px",paddingRight:"3px",paddingLeft:"3px",paddingTop:"0px"}} onClick={handleSave} class="ml-1">Save</span></div>}
                                {show&&<div class="like p-1 cursor"><i class="fa fa-commenting-o"></i><span style={{backgroundColor:"red",color:"white",border:"black solid 2px",borderRadius:"8px",paddingRight:"2px",paddingLeft:"2px"}}  onClick={handleCancelModify} class="ml-1">Cancel</span></div>}
