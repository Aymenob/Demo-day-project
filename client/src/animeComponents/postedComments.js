...
const PostedComments = ({url,text,owner,updatedAt}) => {
                    ...
                    <div class="d-flex flex-column comment-section">
                        <div class="bg-white p-2">
                            <div class="d-flex flex-row user-info"><img style={{borderRadius:"4px"}} class="" src={url} height="43" width="43" />
                                <div class="d-flex flex-column justify-content-start ml-2"><span class="d-block font-weight-bold name">{owner}</span><span class="date text-black-50">Posted publicly - {updated.toUTCString().slice(0, -3)}</span></div>
                            </div>
                            <div class="mt-1">
