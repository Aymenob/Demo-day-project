        ...
        <div style={{marginLeft:'1.5cm',marginTop:"-0.2cm"}} class="col-md-11">
            <div class="d-flex flex-column comment-section">
                ...
                <div class="bg-white p-2">
                    <div class="d-flex flex-row align-items-start"><img  style={{borderRadius:"4px"}} class="" src={url} height="49" width="49" /><textarea placeholder='Insert a comment...' style={{height:"1.3cm",width:"80%",marginLeft:'0.2cm',borderRadius:"4px"}} value={value} onChange={handleType} class="form-control ml-1 shadow-none textarea"></textarea></div>
