                ...
                <div class="col-md-11">
                    <div class="d-flex flex-column comment-section">
                        ...
                        <div style={{marginLeft:"0.4cm",marginTop:"-0.75cm",color:"grey"}} class="">
                            ...
                            <div class="like p-1 cursor"><span style={{fontSize:"13.5px",color:"green",position:"absolute",marginLeft:"-0.15cm"}} >{toggleLike?.length-toggleDeslike?.length>0?toggleLike?.length-toggleDeslike?.length:null}</span></div>
